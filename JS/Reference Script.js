const customRules = [
    ...
    // 【修改1】常用 AI 站点手动钉规则（最高优先级）
    "DOMAIN-SUFFIX,gemini.google.com,AI",
    "DOMAIN-SUFFIX,chatgpt.com,AI",
    "DOMAIN-SUFFIX,openai.com,AI",
    // Facebook 及相关服务走手动选择
    "DOMAIN-SUFFIX,facebook.com,手动选择",
    "DOMAIN-SUFFIX,fbcdn.net,手动选择",
    "DOMAIN-SUFFIX,instagram.com,手动选择",
    "DOMAIN-SUFFIX,whatsapp.com,手动选择",
];
...
const rules = [
    ...
    // 【修改2】把 AI 提前到 Google 前面，避免 Gemini/OpenAI 被 Google 类规则抢先命中
    "RULE-SET,ai,AI",
...
const proxyGroups = [
    ...
    },
    {
        ...
        name: "漏网之鱼",
        type: "select",
        // 【修改5】把默认优先顺序改为先走代理，减少“打开网站失败后手动切节点”
        proxies: [
            "节点选择",
            "手动选择",
            "延迟选优",
